...
/** Accès réservé à l'équipe (pas de compte client : les clients sont recontactés sur WhatsApp). */
  ...
  return (
    <section className="container-x flex min-h-dvh items-center justify-center pt-28 pb-16">
      <div className="w-full max-w-md">
        ...
        <p className="mt-3 text-mute">Accès réservé à l&apos;équipe UNIVERS GRAVURE : demandes, devis, production et finances.</p>
